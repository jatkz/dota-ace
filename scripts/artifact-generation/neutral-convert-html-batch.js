...
async function main() {
    try {
        ...
        console.log(`\n🎮 Dota 2 Neutral Items Conversion`);
        console.log(`📊 Total neutral items: ${DOTA2_ITEMS.activeArtifacts.length}`);
        ...
        if (NORMALIZE_ONLY) {
            ...
            const summary = processDirectory('neutral', conversionDir);
        ...
        const items = DOTA2_ITEMS.activeArtifacts;
            ...
            for (let i = 0; i < response.content.length; i++) {
                ...
                try {
                    ...
                    if (!SKIP_NORMALIZATION) {
                        normalizeFile('neutral', outputPath);
                    }
                    successCount++;
                    console.log(`    ✅ Saved`);
                } catch (saveError) {
